namespace GraderApi.Controllers
{
    ...
    public class GradeComponentsController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> GetGradeComponentModel(int gradeComponentId)
        {
        ...
        public async Task<IHttpActionResult> PostGradeComponentModel(GradeComponentModel gradeComponentModel)
        {
            ...
            return CreatedAtRoute("GradeComponentRoute", new { gradeComponentId = gradeComponentModel.Id }, gradeComponentModel);
        }

        // PUT: api/GradeComponents/5
        [ResponseType(typeof(void))]
        [Authorize(Roles = "CanUpdateGradedPart")]
        public async Task<IHttpActionResult> PutGradeComponentModel(int gradeComponentId, GradeComponentModel gradeComponentModel)
        {
            if (!ModelState.IsValid) {
                return BadRequest(ModelState);
            }
        ...
        public async Task<IHttpActionResult> DeleteGradeComponentModel(int gradeComponentId)
        {
